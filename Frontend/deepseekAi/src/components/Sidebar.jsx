     ...
     <div className="h-full flex flex-col justify-between p-4">
      ...
      <div className="p-1 mt-8 border-t border-gray-600">
        <div className="flex  items-center gap-2 cursor-pointer my-3">
          ...
          />
          <span className="text-gray-300 font-bold">{user?user.firstName:"my profile"}
          </span>
        </div>

          <button
           onClick={handleLogout} className="w-full flex items-center text-sm gap-2 text-white text-sm px-4 py-2 rounded-lg hover:bg-gray-700 duration-300 transition"
          >
            <LogOut className="" />
            Logout
          </button>  
